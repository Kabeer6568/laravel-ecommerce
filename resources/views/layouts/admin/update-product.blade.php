                        ...
                        <div class="login-form">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="slug" type="text" placeholder="Product Slug" >
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="display: flex; gap: 20px; align-items: center;">
                                        <label style="display: flex; align-items: center; gap: 5px; cursor: pointer; margin: 0;">
                                            <input type="radio" name="is_featured" value="1"  style="margin: 0; cursor: pointer;">
                                            <span>Yes</span>
                                        </label>
                                        <label style="display: flex; align-items: center; gap: 5px; cursor: pointer; margin: 0;">
                                            <input type="radio" name="is_featured" value="0"  style="margin: 0; cursor: pointer;">
                                            <span>No</span>
                                        </label>
                                    </div>
                                </div>
